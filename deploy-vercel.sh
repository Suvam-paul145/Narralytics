...
# Vercel Deployment Script for Narralytics
# This script will authenticate and deploy your app to Vercel
...
echo ""
vercel env add VITE_API_URL || echo "Warning: Could not set environment variable. You can add it manually in Vercel Dashboard."
